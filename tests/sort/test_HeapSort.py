...
def test_HeapSort_empty_array_with_reverse():
    arr = []
    expected = []
...
def test_HeapSort_int_array():
    arr = [-1, 15, -10, 25, 37, 44, 96, 102]
    expected = [-10, -1, 15, 25, 37, 44, 96, 102]
    sort.HeapSort(arr)
    assert arr == expected


def test_HeapSort_int_array_with_reverse():
    arr = [-1, 15, -10, 25, 37, 44, 96, 102]
    expected = [102, 96, 44, 37, 25, 15, -1, -10]
    sort.HeapSort(arr, reverse=True)
    assert arr == expected


def test_HeapSort_int_array_with_cmp():
    arr = [-1, 15, -10, 25, 37, 44, 96, 102]
    expected = [-10, -1, 15, 25, 37, 44, 96, 102]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr, cmp=cmp)
    assert arr == expected


def test_HeapSort_int_array_with_reverse_and_cmp():
    arr = [-1, 15, -10, 25, 37, 44, 96, 102]
    expected = [102, 96, 44, 37, 25, 15, -1, -10]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr, reverse=True, cmp=cmp)
    assert arr == expected


def test_HeapSort_sorted_int_array():
    arr = [23,24,25,26,27,28,29,30]
    expected = [23,24,25,26,27,28,29,30]
    sort.HeapSort(arr)
    assert arr == expected


def test_HeapSort_sorted_int_array_with_reverse():
    arr = [23,24,25,26,27,28,29,30]
    expected = [30, 29, 28, 27, 26, 25, 24, 23]
    sort.HeapSort(arr, reverse=True)
    assert arr == expected


def test_HeapSort_sorted_int_array_with_cmp():
    arr = [23,24,25,26,27,28,29,30]
    expected = [23,24,25,26,27,28,29,30]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr, cmp=cmp)
...
def test_HeapSort_sorted_int_array_with_reverse_and_cmp():
    arr = [23,24,25,26,27,28,29,30]
    expected = [30, 29, 28, 27, 26, 25, 24, 23]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr, reverse=True, cmp=cmp)
...
def test_HeapSort_duplicate_element_int_array():
    arr = [45,27,30,-10,-20,93,27,-10,100,93,77]
    expected = [-20, -10, -10, 27, 27, 30, 45, 77, 93, 93, 100]
    sort.HeapSort(arr)
    assert arr == expected

def test_HeapSort_duplicate_element_int_array_with_reverse():
    arr = [45,27,30,-10,-20,93,27,-10,100,93,77]
    expected = [100, 93, 93, 77, 45, 30, 27, 27, -10, -10, -20]
    sort.HeapSort(arr, reverse=True)
    assert arr == expected

def test_HeapSort_duplicate_element_int_array_with_cmp():
    arr = [45,27,30,-10,-20,93,27,-10,100,93,77]
    expected = [-20, -10, -10, 27, 27, 30, 45, 77, 93, 93, 100]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr,cmp=cmp)
...
def test_HeapSort_duplicate_element_int_array_with_reverse_and_cmp():
    arr = [45,27,30,-10,-20,93,27,-10,100,93,77]
    expected = [100, 93, 93, 77, 45, 30, 27, 27, -10, -10, -20]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.HeapSort(arr, reverse=True, cmp=cmp)
...
def test_HeapSort_string_array():
...
def test_HeapSort_string_array_with_reverse():
    arr = ['heap', 'sort', 'is', 'an', 'algorithm',
           'based', 'on', 'Binary', 'Heap', 'data', 'structure']
    expected = ['structure', 'sort', 'on', 'is', 'heap', 'data',
            'based', 'an', 'algorithm', 'Heap', 'Binary']
    sort.HeapSort(arr, reverse=True)
    assert arr == expected


def test_HeapSort_string_array_with_cmp():
    arr = ['heap', 'sort', 'is', 'an', 'algorithm',
           'based', 'on', 'Binary', 'Heap', 'data', 'structure']
    expected = ['Binary', 'Heap', 'algorithm', 'an', 'based', 
            'data', 'heap', 'is', 'on', 'sort', 'structure']
...
def test_HeapSort_string_array_with_reverse_and_cmp():
    arr = ['heap', 'sort', 'is', 'an', 'algorithm',
           'based', 'on', 'Binary', 'Heap', 'data', 'structure']
    expected = ['structure', 'sort', 'on', 'is', 'heap', 'data',
            'based', 'an', 'algorithm', 'Heap', 'Binary']
...
def test_HeapSort_object_array_with_cmp():
    class Product:
        def __init__(self,name,price):
            self.name = name
            self.price = price
    a,b,c,d,e,f,g = [
        Product("Shoes",200000),
        Product("Shirt",155000),
        Product("Jeans",320000),
        Product("Shocks",25000),
        Product("Hat",77000),
        Product("Gloves",178500),
        Product("Boost",469000),
    ]
    arr = [a,b,c,d,e,f,g]
    expected = [d,e,b,f,a,c,g]
    def cmp(x, y): return \
        -1 if x.price < y.price else 1 if x.price > y.price else 0
    sort.HeapSort(arr, cmp=cmp)
    assert arr == expected

def test_HeapSort_object_array_with_reverse_and_cmp():
    class Product:
        def __init__(self,name,price):
            self.name = name
            self.price = price
    ...
    arr = [a,b,c,d,e,f,g]
    expected = [g,c,a,f,b,e,d]
    def cmp(x, y): return \
        -1 if x.price < y.price else 1 if x.price > y.price else 0
    sort.HeapSort(arr, reverse=True, cmp=cmp)
    assert arr == expected

def test_HeapSort_long_int_array():
